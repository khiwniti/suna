...
export async function generateMetadata({ params }): Promise<Metadata> {
  ...
  const fallbackMetaData = {
    title: 'Shared Conversation | Carbon BIM',
    ...
    openGraph: {
      title: 'Shared Conversation | Carbon BIM',
      description: 'Replay this Agent conversation on Carbon BIM',
  ...
  try {
    ...
    const title = projectData.name || 'Shared Conversation | Carbon BIM';
    const description =
      projectData.description ||
      'Replay this Agent conversation on Carbon BIM';
